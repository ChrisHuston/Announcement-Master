...
class BLTI {
    ...
    function redirect() {
        ...
        //print $_POST['launch_presentation_return_url'];
        //$location = $_POST['launch_presentation_return_url']."?lti_errorlog=".htmlentities(urlencode("The floor's on fire... see... *%26* the chair."));
        //$location = $_POST['launch_presentation_return_url']."&lti_errorlog=".rawurlencode("The floor's on fire... see... *&* the chair.");
        $params = "?embed_type=oembed&url=http://www.flickr.com/photos/bees/2341623661/&endpoint=http://www.flickr.com/services/oembed/";
        $location = $_POST['launch_presentation_return_url'].$params;
